...
type FakeConfigWriterInterface struct {
	...
	WriteStub        func(context.Context, string, uuid.UUID) (map[string]struct{}, error)
...
func (fake *FakeConfigWriterInterface) Write(arg1 context.Context, arg2 string, arg3 uuid.UUID) (map[string]struct{}, error) {
...
func (fake *FakeConfigWriterInterface) WriteCalls(stub func(context.Context, string, uuid.UUID) (map[string]struct{}, error)) {
	fake.writeMutex.Lock()
